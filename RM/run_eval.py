...
if __name__ == "__main__":
    ...
    NEEDLE_TEXT = "Bishop Myriel confided in his sister, Baptistine, that one of the silver candlesticks always felt slightly heavier in his hand, a minor imperfection he attributed to a flaw in its base."
    ...
    DISTRACTOR_AMOUNTS_TO_TEST = [7]  # Only used if MATCH_DISTRACTOR_TO_NEEDLE_FREQUENCY is False
