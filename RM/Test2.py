...
class ExperimentRunner:
    ...
    def run_experiment(self, config: Dict):
        ...
        # Prompt for needle frequency testing
    ...
    def save_results(self, filename="Test2_Frequency_Results.json"):
...
if __name__ == "__main__":
    ...
    INPUT_CSV = "needles_and_questions.csv" 
    DELAY_SECONDS = 60
    ...
    for item in all_data:
        ...
        for freq in needle_frequencies:
            nc = NeedleConfig(
            ...
            experiments.append({
                "name": f"FrequencyTest_ID{n_id}_Pos{pos*100:.0f}%_Freq{freq}",
                "needle": nc,
                "question": qc
            })
